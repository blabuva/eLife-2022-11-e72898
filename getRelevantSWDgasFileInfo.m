function metaData = getRelevantSWDgasFileInfo(currentRow) 
...
metaData.SWDinfo.excelFile = currentRow.SWDExcelFileName ;
metaData.SWDinfo.excelFilePath = currentRow.SWDsExcelPath ;
